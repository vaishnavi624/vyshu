								...
								<tr>
									<td width="90">
										<div id="menu" align="center">
											<a href="<jstlcore:url value="login.html"/>"> Logout </a>
										</div>
									</td>
									<td width="160">
										<div id="menu" align="center">
											<a
												href="<jstlcore:url value="changepassword.html?uName=${visitor.userName}"/>">
												Change_Password </a>
										</div>
									</td>
									<td width="160">
											...
											<div id="coursesbody" align="left">
												<p>
													...
													change your information,<a
														href="<jstlcore:url value="update.html?vName=${visitor.userName}"/>">click
														here </a>
